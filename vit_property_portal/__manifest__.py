...

{
	...
	"assets": {
		'web.assets_frontend': [
			...
			'vit_property_portal/static/src/js/token_resell_detail.js',
			'vit_property_portal/static/src/js/token_resell_price_autofill.js',
			'vit_property_portal/static/src/js/property_map.js',
			'vit_property_portal/static/src/css/property_portal.css',
			'vit_property_portal/static/src/css/input_range.css',
			'vit_property_portal/static/src/css/image_gallery.css',
		],
	},
	"installable": True,
	"auto_install": False,
